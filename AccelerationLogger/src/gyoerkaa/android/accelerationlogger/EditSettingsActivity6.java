...
public class EditSettingsActivity6 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextInterval = (EditText) findViewById(R.id.settings_updaterate);              
        ...
        buttonReset.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
        	    ...
        	    editTextInterval.setText(Integer.toString(Settings.DEFAULT_UPDATERATE), TextView.BufferType.EDITABLE);
            }
        });
        ...
        buttonOK.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	...
            	message.putInt(Settings.KEY_UPDATERATE, currentSettings.updaterate);
	    ...
	    // Time Interval
        editTextInterval.setText(String.valueOf(currentSettings.updaterate), 
        		                 TextView.BufferType.EDITABLE); 	    		
    ...
    protected void readSettings() {	 	      	 	
        ...
        // Interval
        currentSettings.updaterate     = Integer.valueOf(editTextInterval.getText().toString());            
	 	if (currentSettings.updaterate <= Settings.MIN_RATE) {
            Toast toast;    	 	
 	        toast = Toast.makeText(getApplicationContext(), 
                    "Ungültiges Intervall (min. " + Integer.valueOf(Settings.MIN_RATE) + " ms)", 
                    Toast.LENGTH_SHORT);
            toast.show();
        
            currentSettings.updaterate = Settings.MIN_RATE;         	
        }       
